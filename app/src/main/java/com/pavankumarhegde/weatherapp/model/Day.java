...
public class Day {
    ...
    public Day(double maxtemp_c, double mintemp_c, double avgtemp_c, double maxwind_kph, double totalprecip_mm, double avgvis_km, int avghumidity, int uv, int daily_will_it_rain, int daily_chance_of_rain, Condition condition) {
